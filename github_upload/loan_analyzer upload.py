...
print("The number of loans is:", num_loans)
...
print("The total value of all loans is:", total_loan_value)
...
# YOUR CODE HERE!
average_loan_amount = total_loan_value / num_loans
...
#Write each loan in 'inexpensive_loans' to new rows
